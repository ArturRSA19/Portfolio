...
const I18N = {
  en: {
    ...
    'hero.heading_post': '.',
    'hero.body': 'Software Engineering student at <strong>UnB</strong> and Full-Stack Developer passionate about building reliable, performant solutions. I mainly work with <strong>Python</strong>, <strong>C#/.NET</strong>, <strong>React/Next.js</strong>, <strong>React Native</strong>, <strong>Flutter</strong>, and <strong>TypeScript</strong>. Experienced in both legacy system maintenance and modern BI implementations, with extensive participation in academic projects including UnB accessibility extension projects, DNIT partnerships, and MEPA Energia collaborations. <br><br>When I\'m not coding or studying, you\'ll find me playing soccer, hitting the gym, or cheering for Cruzeiro. I also love gaming in my free time and I\'m currently developing a new habit of reading more books.',
  ...
  pt: {
    ...
    'hero.heading_post': '.',
    'hero.body': 'Estudante de Engenharia de Software na Universidade de Brasília (UnB) especializado em desenvolvimento Full-Stack. Acostumado a construir soluções confiáveis, escaláveis e performáticas. Trabalho com diversas stacks, mas principalmente com <strong>React/Next.js</strong>, <strong>React Native</strong>, <strong>TypeScript</strong>, <strong>Python</strong>, <strong>Flutter</strong> e <strong>C#/.NET</strong>. Experiente na implementação de BI moderno, com ampla participação em projetos acadêmicos incluindo extensão de acessibilidade da UnB, parcerias com DNIT e colaborações com MEPA Energia. <br><br>Sou uma pessoa bastante comunicativa e parceira. Gosto de estudar e sei o quão importante é, para mim, adquirir o máximo de conhecimento possível. Quando não estou estudando ou programando, eu normalmente estarei jogando bola (torço para o melhor time do mundo - Cruzeiro Esporte Clube), na academia, com minha namorada ou com meus amigos. Também adoro jogar no meu tempo livre e estou desenvolvendo um novo hábito de leitura.',
